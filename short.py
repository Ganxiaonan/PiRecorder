...
class VideoPlayer(ttk.Frame):
    ...
    def _build_widget(self, parent: ttk.Frame=None, setup: dict=dict):
        ...
        icons_path = os.path.abspath(os.path.join(os.pardir, 'icon'))
        if setup['play']:
...
#             button_load_image.pack(side='left')
    ...
    def camera_capture(self):
        ...
        self.__out = cv2.VideoWriter('/home/pi/Desktop/images/outpy.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (640,480))
